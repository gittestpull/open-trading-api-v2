...
def changeTREnv(token_key, svr="prod", product=_cfg["my_prod"]):
    ...
    cfg["my_app"] = os.getenv("KIS_APP_KEY", _cfg[ak1])
    cfg["my_sec"] = os.getenv("KIS_APP_SECRET", _cfg[ak2])
...
def auth(svr="prod", product=_cfg["my_prod"], url=None):
    ...
    if svr == "prod":
        p["appkey"] = os.getenv("KIS_APP_KEY", _cfg[ak1])
        p["appsecret"] = os.getenv("KIS_APP_SECRET", _cfg[ak2])
    else:
        p["appkey"] = _cfg[ak1]
...
def auth_ws(svr="prod", product=_cfg["my_prod"]):
    ...
    if svr == "prod":
        p["appkey"] = os.getenv("KIS_APP_KEY", _cfg[ak1])
        p["secretkey"] = os.getenv("KIS_APP_SECRET", _cfg[ak2])
    else:
        p["appkey"] = _cfg[ak1]
